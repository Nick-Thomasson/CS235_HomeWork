...
float grade_percent;
grade_percent = (my_score / points_possible) * 100;
...
if (grade_percent > 89.5){
cout << "Your grade letter is A" << endl;
letter_grade = 'A';}

else if (grade_percent > 79.5){
cout << "Your grade letter is B" << endl;
letter_grade = 'B';}
else if (grade_percent > 69.5){
cout << "Your grade letter is C" << endl;
letter_grade = 'C';}
else if (grade_percent > 59.5){
cout << "Your grade letter is D" << endl;
letter_grade = 'D';}
else {
cout << "Your grade letter is F" << endl;}
...
cout << "Points Possible: " << points_possible << endl;
cout << "Grade percent: " << grade_percent << endl;
